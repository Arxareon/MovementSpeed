...
ns.localizations.enUS = {
	options = {
		main = {
			description = "Customize #ADDON to fit your needs. Type #KEYWORD1 or #KEYWORD2 for chat commands.",
			shortcuts = {
				title = "Shortcuts",
...
ns.localizations.ptBR = {
	options = {
		main = {
			description = "Personalize o #ADDON para atender às suas necessidades. Digite #KEYWORD1 ou #KEYWORD2 para comandos de chat.",
			shortcuts = {
				title = "Atalhos",
...
ns.localizations.deDE = {
	options = {
		main = {
			description = "Passe #ADDON nach deinen Bedürfnissen an. Gib #KEYWORD1 oder #KEYWORD2 für Chatbefehle ein.",
			shortcuts = {
				title = "Kurzbefehle",
...
ns.localizations.frFR = {
	options = {
		main = {
			description = "Personnalisez #ADDON selon vos besoins. Tapez #KEYWORD1 ou #KEYWORD2 pour les commandes de chat.",
			shortcuts = {
				title = "Raccourcis",
...
ns.localizations.esES = {
	options = {
		main = {
			description = "Personaliza #ADDON según tus necesidades. Escribe #KEYWORD1 o #KEYWORD2 para comandos de chat.",
			shortcuts = {
				title = "Atajos",
...
ns.localizations.itIT = {
	options = {
		main = {
			description = "Personalizza #ADDON secondo le tue esigenze. Digita #KEYWORD1 o #KEYWORD2 per i comandi in chat.",
			shortcuts = {
				title = "Scorciatoie",
...
ns.localizations.koKR = {
	options = {
		main = {
			description = "#ADDON을 필요에 맞게 설정하세요. 채팅 명령어로 #KEYWORD1 또는 #KEYWORD2를 입력하세요.",
			shortcuts = {
				title = "바로가기",
...
ns.localizations.zhTW = {
	options = {
		main = {
			description = "自訂#ADDON以符合您的需求。輸入#KEYWORD1或#KEYWORD2以使用聊天指令。",
			shortcuts = {
				title = "捷徑",
...
ns.localizations.zhCN = {
	options = {
		main = {
			description = "自定义#ADDON以满足您的需求。输入#KEYWORD1或#KEYWORD2以使用聊天命令。",
			shortcuts = {
				title = "快捷方式",
...
ns.localizations.ruRU = {
	options = {
		main = {
			description = "Настройте #ADDON под свои нужды. Введите #KEYWORD1 или #KEYWORD2 для команд чата.",
			shortcuts = {
				title = "Ярлыки",
