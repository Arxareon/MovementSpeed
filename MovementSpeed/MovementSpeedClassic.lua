...
---@return number
local GetPlayerSpeed = select(4, GetBuildInfo()) < 30000 and function() return GetUnitSpeed("player") end or function()
...
local function CreateOptionsShortcuts(parentFrame)
	...
	local speedDisplayPage = wt.CreateButton({
		...
		tooltip = { lines = { [0] = { text = ns.strings.options.speedDisplay.description:gsub("#ADDON", addonTitle) }, } },
	...
	wt.CreateButton({
		...
		tooltip = { lines = { [0] = { text = ns.strings.options.targetSpeed.description:gsub("#ADDON", addonTitle) }, } },
		position = {
...
local function CreateContextMenuItems()
	return {
		...
		},
		{
			...
			notCheckable = true,
			func = function() options.speedDisplayOptions.open() end,
		},
		{
			text = ns.strings.options.targetSpeed.title,
			notCheckable = true,
			func = function() options.targetSpeedOptions.open() end,
		},
		{
