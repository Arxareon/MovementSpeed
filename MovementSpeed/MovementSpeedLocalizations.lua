...
local changelogDB = {
	...
	[8] = {
		...
		[6] = "Updated the look and feel of the interface options to be on par with the Remaining XP addon. Right-click on the speed display to open specific options pages.",
		...
		[18] = "Additional changes & small fixes.",
		[19] = "#O_Coming soon:_#",
		[20] = "Options profiles for character-specific customization.",
		[21] = "Different styles and looks for the speed display.",
		[22] = "Some cool new features are being explored, more on that soon™!",
	},
}
