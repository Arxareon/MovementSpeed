...
ns.changelog = {
	...
	},
	{
		...
		"Added more positioning options allowing for more fine-tuning.",
		"Positioning visual aids have been added via Widget Tools (a foundational addon - also developed by me - Movement Speed is built on). Toggle it in the Widget Tools settings.",
